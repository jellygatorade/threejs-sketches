...
Renderer.prototype = {
  ...
  placeCamera() {
    if (this.camera.center == null) return;
    ...
    this.camera.position.y =
      ...
      Math.cos(this.cameraPitch) * this.cameraRadius * this.cameraZoom;
    this.camera.lookAt(
      this.camera.center.x,
      this.camera.center.y,
      this.camera.center.z
    ...
    this.light.position.set(
      Math.cos(this.cameraRotation + this.LIGHT_ANGLE_OFFSET) *
        Math.sin(this.LIGHT_ANGLE_PITCH),
      Math.cos(this.LIGHT_ANGLE_PITCH),
      Math.sin(this.cameraRotation + this.LIGHT_ANGLE_OFFSET) *
        Math.sin(this.LIGHT_ANGLE_PITCH)
    );
  },
  ...
  paint() {
    if (this.scene != null) this.renderer.render(this.threeScene, this.camera);
  },
